...
par_names = ("memories", "cuts") #nomi dei parametri

#dizionario con i nomi dei parametri come indici e i parametri come tuple di valori
parameters = {par_names[0]: ('1g','2g'),
             par_names[1]: (0.997,0.998),
             #par_names[2]: (4,8,16,32),
             #par_names[3]: (1,2,3,4)
             }
...
comb_names = [(par_names[combinations[i][0]], par_names[combinations[i][1]]) for i in range(1)]
